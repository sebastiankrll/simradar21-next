...
export default function Footer({ icao }: { icao: string }) {
    ...
    return (
        <div className="info-panel-container footer">
            ...
            <button className={`info-panel-footer-button ${pathname.split('/')[3] === 'arrival' ? 'highlight' : ''}`} onClick={() => clickPage('arrival')}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
