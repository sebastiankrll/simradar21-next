...
export default function Footer({ data }: { data: FlightData | undefined | null }) {
    ...
    const clickRoute = () => {
        ...
        // if (path[1] === 'flight' && path[3] === 'route') {
        //     navigate('flight/' + dataRef.current.route.general.general.callsign)
        // } else {
        //     if (dataRef.current.route.general.airports.dep.coords) {
        //         navigate('flight/' + dataRef.current.route.general.general.callsign + '/route')
        //     }
        // }
    }
    ...
    const clickFollow = () => {
        ...
        // if (path[1] === 'flight' && path[3] === 'follow') {
        //     navigate('flight/' + dataRef.current.route.general.general.callsign)
        // } else {
        //     navigate('flight/' + dataRef.current.route.general.general.callsign + '/follow')
        // }
    }
    ...
    return (
        <div className="info-panel-container footer">
            <button className={`info-panel-footer-button`} onClick={clickRoute}>
            ...
            <button className={`info-panel-footer-button`} onClick={clickFollow}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
