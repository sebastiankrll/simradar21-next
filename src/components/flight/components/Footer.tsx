...
export default function Footer({ data }: { data: FlightData | undefined | null }) {
    ...
    return (
        <div className="info-panel-container footer">
            <button className={`info-panel-footer-button ${action === 0 ? 'highlight' : ''}`} onClick={clickRoute}>
            ...
            <button className={`info-panel-footer-button ${action === 1 ? 'highlight' : ''}`} onClick={clickFollow}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
