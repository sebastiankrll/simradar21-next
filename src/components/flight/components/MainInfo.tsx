    ...
    return (
        <div className="info-panel-container column main scrollable">
            {data.general?.flightplan &&
                <>
                    <button className='info-panel-container-header' onClick={() => openDropdown('more')}>
                    ...
                    <Dropdown open={panelStates.more} className="column sub">
            ...
            <button className='info-panel-container-header' onClick={() => openDropdown('graph')}>
            ...
            <Dropdown open={panelStates.graph} className="column sub">
                <div className='info-panel-container sub'>
                    <div className='info-panel-flow-section'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            <path fillRule="evenodd"
            ...
            <LiveData data={data} />
            <button className='info-panel-container-header' onClick={() => openDropdown('pilot')}>
            ...
            <Dropdown open={panelStates.pilot} className="column sub">
                <div className='info-panel-container sub'>
                    <div className='info-panel-flow-section'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            <path fillRule="evenodd"
