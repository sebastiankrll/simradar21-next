...
// export const AirportOverlay = ({ feature, airport }: { feature: Feature, airport: }) => {
...
//                                     {station.cs}
//                                     <span className={`popup-content-box frequency ${getFrequencyColor(station.fc)}`}>{station.fq}</span>
...
//                         </svg>
//                     </div>
//                     <div className='popup-airport-info-n'>{airport ? airport.dep : 0}</div>
//                     <div className='popup-airport-info-icon'>
//                         <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
...
//                         </svg>
//                     </div>
//                     <div className='popup-airport-info-n'>{airport ? airport.arr : 0}</div>
//                 </div>
//             </div>
